...
class GblabSheet implements FromCollection,WithHeadings,ShouldAutoSize,WithMapping,WithTitle
{
    ...
    {
        $gblab = Gbpersona::Select(DB::raw("id_persona,par_fuerza,telofi,par_profesion,numero_papeleta,to_char(fecha_ingreso_trabajo,'DD/MM/YYYY'),to_char(fecha_reg::timestamp::date,'DD/MM/YYYY'),usuario_reg,fecha_reg::timestamp::time as hora_reg"))->orderByRaw('id_persona::numeric asc')->get();
        return $gblab;
    }
